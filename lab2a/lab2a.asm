...
GETCHAR GETC 			; Taking char as input from keyboard
OUT  			; Echo char input to screen

LD R1, SPACE		; Load the ascii value of space into R1
NOT R1, R1
Add R1, R1, #1 		; 2's Complement Negation
ADD R1, R1, R0 		; R1 = R0 + R1(-SPACE) = 0
BRz GETCHAR

LD R1, NEW_LINE		; Load the ascii value of new line into R1
NOT R1, R1
Add R1, R1, #1 		; 2's Complement Negation
ADD R1, R1, R0 		; R1 = R0 + R1(-NEW_LINE) = 0
BRz DONE
...
ST R7, BAL_SAVER7 ; Store R7
JSR PUSH
LD R7, BAL_SAVER7 ; Load R7
RET
